...
<?php get_template_part( 'template-parts/breadcrumb-works' ); ?>
    ...
    <div class="l-primary">
      ...
      <article class="p-works-entry">
        <header class="p-works-entry__header">
          ...
          <a class="p-works-entry__cat"><?php echo esc_html( $categories[0]->name ); ?></a>
          <?php endif; ?>
        ...
        <?php if ( $dp_options['works_show_next_post'] && ( $previous_post || $next_post ) ) : ?>
			  <ul class="p-nav01 c-nav01 u-clearfix">
			  	<li class="p-nav01__item--prev p-nav01__item c-nav01__item c-nav01__item--prev"><?php if ( $previous_post ) : ?><a href="<?php echo esc_url( get_permalink( $previous_post->ID ) ); ?>"><span><?php echo esc_html( wp_trim_words( $previous_post->post_title, 26, '...' ) ); ?></span></a><?php endif; ?></li>
			  	<li class="p-nav01__item--next p-nav01__item c-nav01__item c-nav01__item--next"><?php if ( $next_post ) : ?><a href="<?php echo esc_url( get_permalink( $next_post->ID ) ); ?>"><span><?php echo esc_html( wp_trim_words( $next_post->post_title, 26, '...' ) ); ?></span></a><?php endif; ?></li>
			  </ul>
        <?php endif; ?>
