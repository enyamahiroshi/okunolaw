...
if ( is_singular( 'company' ) ) {
  ...
  if ( is_mobile() ) {
    echo '<li class="p-list__item p-list__item--has-children t">';
    echo '<a href="' . get_post_type_archive_link( $post_types[0] ) . '">';
    echo 'service' === $post_types[0] ? $service_label : __( 'カテゴリー一覧', 'tcd-w' );
    echo '<span class="p-list__item-toggle"></span>';
    echo '</a>';
    echo '<ul class="p-list__item-sub" style="display: none;">';
  }
  ...
  if ( is_mobile() ) {
    ...
    echo 'service' === $post_type ? $service_label : __( 'カテゴリー一覧', 'tcd-w' );
    echo '<span class="p-list__item-toggle"></span>';
    echo '</a>';
    echo '<ul class="p-list__item-sub" style="display: none;">';
  } elseif ( is_singular( 'post' ) ) {
    echo '<li class="p-list__item">';
    echo '<a href="' . get_post_type_archive_link( 'post' ) . '">' . __( 'カテゴリー一覧', 'tcd-w' ) . '</a>';
    echo '</li>';
  }
