...
<div id="js-header-slider" class="p-header-slider" data-speed="<?php echo esc_attr( $dp_options['header_slider_animation_time'] * 1000 ); ?>">
    ...
    <div class="p-header-content__title<?php if ( $vertical ) { echo ' p-header-content__title--vertical'; } ?> ">
      <span class="logo"><img src="wp-content/themes/nano_tcd065/assets/images/ico-white.svg" alt="奥野総合法律事務所･外国法共同事業" /></span>
      <span class="jp_w wf-sawarabimincho fadeinUp">奧野総合法律事務所<br class="visible-xs"/><span class="hidden-xs">･</span>外国法共同事業</span>
      <span class="border_anime"></span>
      <span class="en_w fadeDown">OKUNO&PARTNERS</span>
    </div>
  <?php
  for ( $i = 1; $i <= 5; $i++ ) :
  ...
  <a href="#js-cb" id="js-header-content__link" class="p-header-content__link" aria-hidden="true">
    scroll
  </a>
</div>
