...
<body <?php body_class(); ?>>
  ...
  <header id="js-header" class="jp-header l-header<?php if ('type2' === $header_fix) {
                                                    echo ' l-header--fixed';
                                                  } ?>">
    <div class="l-header__inner l-inner">
      ...
      <?php endif; ?>
      <?php /* eureka 211104 [仕様変更]#0003 アクセス、お問い合わせボタン追加 */ ?>
      <div class="header-wrap-btn header-wrap-btn-pc">
        <div class="btn-access"><a href="<?php echo esc_url(home_url('/outline/aboutus/#block_03')); ?>">アクセス</a></div>
        <div class="btn-contact"><a href="<?php echo esc_url(home_url('/contact')); ?>">お問い合わせ</a></div>
      </div>
      <div class="global_change">
        <a href="<?php echo esc_url(home_url('/')); ?>" class="b_jp">JP</a> / <a href="<?php echo esc_url(home_url('/')); ?>en/" class="b_en">EN</a>
      </div>
    </div>
    ...
    <nav id="js-header__nav" class="l-header__nav">
      ...
      <?php /* eureka 211104 [仕様変更]#0003 アクセス、お問い合わせボタン追加 */ ?>
      <div class="header-wrap-btn header-wrap-btn-mobile">
        <div class="btn-access"><a href="<?php echo esc_url(home_url('/outline/aboutus/#block_03')); ?>">アクセス</a></div>
        <div class="btn-contact"><a href="<?php echo esc_url(home_url('/contact')); ?>">お問い合わせ</a></div>
      </div>
