...
<div class="l-contents l-contents--grid<?php if ( 'type2' === $dp_options['sidebar'] ) { echo '-rev'; } ?>">
  <div class="l-contents__inner l-inner">
    ...
    <div class="l-primary l-insight">
      <section class="p-blog">
        <div class="p-blog__list list-insight">
          <?php
          if ( have_posts() ) :
            while ( have_posts() ) :
              the_post();
          ...
          <article class="p-blog__list-item p-article01 item-insight" data-aos="custom-fade">
            <a class="p-hover-effect--<?php echo esc_attr( $dp_options['hover_type'] ); ?> item-insight__link" href="<?php the_permalink(); ?>">
              <?php /* アイキャッチ画像
              ...
              */ ?>
              ...
              <?php /* before:220915 「コラムタイトル+記事抜粋」
              ...
              */ ?>
              <?php // ACF: 執筆者の入力があれば表示
              $cf_writer = get_field('cf_writer');
              if($cf_writer) {
                echo '<p class="p-article01__excerpt item-insight__excerpt"><span>執筆者</span>' . $cf_writer . '</p>';
              }
              ?>
