        ...
        <div class="p-entry__inner">
          ...
          <?php if ( $dp_options['news_show_next_post'] && ( $previous_post || $next_post ) ) : ?>
                    <ul class="p-nav01 c-nav01 u-clearfix">
          			    	<li class="p-nav01__item--prev p-nav01__item c-nav01__item c-nav01__item--prev"><?php if ( $previous_post ) : ?><a href="<?php echo esc_url( get_permalink( $previous_post->ID ) ); ?>" data-prev="<?php _e( 'Previous post', 'tcd-w' ); ?>"><span class="sp_str">古い記事</span><span><?php echo esc_html( wp_trim_words( $previous_post->post_title, 26, '...' ) ); ?></span></a><?php endif; ?></li>
          			    	<li class="p-nav01__item--next p-nav01__item c-nav01__item c-nav01__item--next"><?php if ( $next_post ) : ?><a href="<?php echo esc_url( get_permalink( $next_post->ID ) ); ?>" data-next="<?php _e( 'Next post', 'tcd-w' ); ?>"><span class="sp_str">新しい記事</span><span><?php echo esc_html( wp_trim_words( $next_post->post_title, 26, '...' ) ); ?></span></a><?php endif; ?></li>
          			    </ul>
          <?php endif; ?>
